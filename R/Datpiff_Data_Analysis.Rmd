...
stat_plot(freq_stats) +
  ggtitle("Mixtape Uploads per Month") +
...
stat_plot(listens_downloads) +
  scale_x_date(limits = c(ymd("2010-01-01", NA))) + 
...
stat_plot(lpv_dpv) + 
  ...
  ggtitle("Listen and Download Rates") + 
  xlab("Release Month") +
  ylab("Downloads per View") + 
  theme_minimal() + 
  scale_x_date(date_labels = "%b-%y", date_breaks = "2 years", limits = c(ymd("2009-06-30"), NA)) +
  scale_y_continuous(limits = c(0, 0.55), breaks = seq(0, 0.50, 0.1)) + 
  scale_color_discrete(name = NULL, labels = c("Listens per View", "Downloads per View"))
